      ...
      <View style={styles.container}>
        ...
        <View style={styles.doctorDate}>
          ...
          <View style={styles.DoctorInfo}>
            <Text style={styles.doctorName}>王医生</Text>
            <Text style={styles.doctorAffiliation}>爱尔后门诊室</Text>
            <Text style={styles.doctorAffiliationRoom}>
              <Text style={styles.officeRoom}>口腔科</Text> 医师
            </Text>
          </View>
        </View>
        <ScrollableTabView
